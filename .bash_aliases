...
#     Git
#
alias ggraph="git log --graph --no-abbrev-commit --decorate=full --all --color=always --date=iso --log-size --raw --stat --pretty=oneline"
alias ggpf="git pull ; git fetch --all ; git fetch --prune ; git fetch -fup origin \"+refs/*:refs/*\""
...
alias x509dec='openssl x509 -noout -text'
alias x509decf='openssl x509 -noout -text -in'
