...
alias decodecert='python3 -c "from cryptography import x509; from cryptography.hazmat.backends import default_backend; import sys; cert_data = open(sys.argv[1], \"rb\").read(); cert = x509.load_pem_x509_certificate(cert_data, default_backend()); print(cert.subject.rfc4514_string())"'
