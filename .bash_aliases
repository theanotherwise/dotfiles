...
#     Git
#
alias glog="git log --graph --no-abbrev-commit --decorate=full --all --color=always --date=iso --log-size --raw --stat"
alias gpull="git pull ; git fetch --all ; git fetch --prune ; git fetch -fup origin \"+refs/*:refs/*\""
